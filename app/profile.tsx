  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        if (!licenseKey) {
          setError('Lisans bulunamadı. Lütfen tekrar giriş yapın.');
          return;
        }
      ...
      <View style={styles.content}>
        ...
        {!loading && error && (
          <View style={styles.center}>
            ...
            <TouchableOpacity style={styles.primaryBtn} onPress={() => router.replace('/license')}>
              <Text style={styles.primaryBtnText}>Lisans Ekranına Dön</Text>
            </TouchableOpacity>
          </View>
        )}
        ...
        {!loading && profile && (
          <View style={styles.card}>
            ...
            <Text style={styles.label}>Lisans Anahtarı</Text>
            ...
            <Text style={styles.label}>Kalan Gün</Text>
